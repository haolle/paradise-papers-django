...
Where ``fetch_api`` is the name of the application we are creating, if you prefer you can use any
other name.  This will create a new folder inside the Django project directory, and the structure
of it is: ::
